    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3">
          <Link href="/admin/tests" className="flex items-center gap-2 bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition-colors">
            <TestTube className="w-5 h-5" />
            Tests
          </Link>
          <Link href="/admin/packages/new" className="flex items-center gap-2 bg-primary text-white px-4 py-2 rounded-lg hover:bg-[#8a3a7a] transition-colors">
